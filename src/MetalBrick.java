...
public class MetalBrick extends Brick {
    ...
    public MetalBrick(int xPosition, int yPosition) throws SlickException {
        ...
        Image i = new Image("res/UIElements/brick_metal_3alt.png");
        Image i2 = new Image("res/UIElements/brick_metal_2.png");
        Image i3 = new Image("res/UIElements/brick_metal.png");
        super.addImage(i,1);
        super.addImage(i2,2);
        super.addImage(i3,3);
        super.createHitBox();
